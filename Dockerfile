...
# cleanup
RUN rm -f target/release/deps/cerebot2* target/release/deps/backend* target/release/deps/libpersistence* target/release/deps/libutil* target/release/deps/libunogs_client*
RUN rm -f target/release/cerebot2* target/release/backend* target/release/libpersistence* target/release/libutil* target/release/libunogs_client*
# copy full source
COPY . .
